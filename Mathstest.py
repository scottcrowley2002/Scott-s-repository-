...
#This allows you to put your code to sleep whenever your type sleep(and then an amount of time in these brackets)
score = 0
#This makes your score to 0 so whenever you get a question right you can add a point to the score
...
sleep(2.5)
#This sleep just makes the code stop for 2 seconds
print("CALCULATING...")
sleep(2)
#This sleep stops the code for 2 seconds 
count_to = 100 * (score) / 20
#This code multiplies your score by 100 and divides it by 20 to calculate your percentage
print (str(count_to) +'%')
"""I have had to make this a string because you can't add words and numbers or signs in a code because it won't work"""
